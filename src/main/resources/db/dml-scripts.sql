...
VALUES ('260f7043-d0bf-4d99-b143-6ee555685561', 'Meta Quest 2', 299.99, 1000, 'Experience the power of VR. Discover new adventures, master epic challenges or revisit classic moments in your favorite games and experiences. Explore VR on a platform you can trust, with enhanced privacy features that encrypt your data and supervision tools that keep content friendly for everyone in the family.', 'quest2.png'),
       ...
       ('260f7043-d0bf-4d99-b143-6ee555685570', 'Meta Quest 3 Elite Strap', 69.99, 100, 'Play in comfort with this ergonomic strap that easily adjusts to most head sizes with the turn of a dial.', 'quest3elitestrap.png'),
       ('260f7043-d0bf-4d99-b143-6ee555685571', 'Meta Quest 3 Elite Strap with Battery', 129.99, 50, 'Play in comfort and get up to 2 hours additional VR game play time with this ergonomic, adjustable head strap that features a built-in battery pack.', 'quest3elitestrap.png'),
